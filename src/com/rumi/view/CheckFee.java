 ...
 * @author Forryq
 */
public class CheckFee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 202, 1640, 490);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            List<Fee> list = commonService.getListByMonthAndYear(month, year);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckFee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
